"""
Script to seed the database with initial activity data.
"""
...
def seed_database():
    ...
    try:
        ...
        if existing_count > 0:
            print(f"Database already seeded with {existing_count} activities. Skipping...")
            return
        ...
        # Commit all changes
        db.commit()
        print(f"Successfully seeded database with {len(INITIAL_ACTIVITIES)} activities!")
